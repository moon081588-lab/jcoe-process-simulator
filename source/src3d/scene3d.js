...
function buildStat(){
  /* 막대 id 에도 v3_ 접두어를 붙인다.
     2D 사이드 패널(ui.js)도 같은 이름(sf_EM12 …)으로 막대를 만들기 때문에,
     접두어가 없으면 한 문서 안에 id 가 중복되어 이 안의 $() 가 3D 막대를 찾지 못하고
     **가동률이 전부 0% 로 보였다.** (2026-08-14 2D·3D 통합 후 발견) */
