...
const REF_STD_DEFAULT = {
  ...
  RT: { _label:'18. RT (X-ray)', _src:'row 28~30',
  ...
  Packing: { _label:'19. 포장', _src:'row 31',
    base:{v:634,u:'s',l:'기본'},
